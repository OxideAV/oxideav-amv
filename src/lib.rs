...
//! reverse-engineering of real AMV file samples in a future clean-room
//! round.
//!
...
pub enum Error {
    ...
    /// rebuild; no demuxer or decoder functionality is wired up yet.
    NotImplemented,
}
...
impl core::fmt::Display for Error {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        write!(
            f,
            "oxideav-amv: orphan-rebuild scaffold — no decoder wired up"
        )
    }
}
